@extends('layouts.app')
@section('title', __('item.hsn_summary_report'))
        ...
        <div class="page-wrapper">
            <div class="page-content">
                <x-breadcrumb :langArray="[
                                            'app.reports',
                                            'item.hsn_summary_report',
                                        ]"/>
                <div class="row">
                    <form class="row g-3 needs-validation" id="reportForm" action="{{ route('report.hsn_summary.ajax') }}" enctype="multipart/form-data">
                        {{-- CSRF Protection --}}
                        @csrf
                        @method('POST')
                            ...
                            <div class="card">
                                ...
                                <div class="card-body p-4 row g-3">
                                        <div class="col-md-12 table-responsive">
                                            <table class="table table-bordered" id="hsnReport">
                                                <thead>
...
@section('js')
    ...
    <script src="{{ versionedAsset('custom/js/reports/hsn-summary.js') }}"></script>
