        ...
        <div class="page-wrapper">
            <div class="page-content">
                <x-breadcrumb :langArray="[
                                            ...
                                            'warehouse.stock_adjustment_report',
                                        ]"/>
                <div class="row">
                    <form class="row g-3 needs-validation" id="reportForm" action="{{ route('report.stock_adjustment.ajax') }}" enctype="multipart/form-data">
                        {{-- CSRF Protection --}}
                        @csrf
                        @method('POST')
