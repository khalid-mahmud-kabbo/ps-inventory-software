...
@endsection
        ...
        <div class="page-wrapper">
            <div class="page-content">
                    ...
                    <div class="card-header px-4 py-3 d-flex justify-content-between">
                        ...
                        <div>
                            <h5 class="mb-0 text-uppercase">{{ __('payment.bank_transactions') }} : <span id="cashInBankTotal" class="cash-in-bank text-success">0</span></h5>
                        </div>
                        ...
                        <button role="button" class="btn btn-primary px-5 make-bank-adjustment">{{ __('payment.bank_adjust') }}</button>
</div>
                    ...
                    <div class="card-body">
                        ...
                        <form class="row g-3 needs-validation" id="datatableForm" action="{{ route('bank.transaction.delete') }}" enctype="multipart/form-data">
        ...
        @include("modals.transaction.cash-in-bank")
...
<script src="{{ versionedAsset('custom/js/modals/transaction/cash-in-bank.js') }}"></script>
@endsection
