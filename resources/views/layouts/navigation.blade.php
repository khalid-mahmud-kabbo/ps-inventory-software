<!--sidebar wrapper -->
		<div class="sidebar-wrapper" data-simplebar="true">
			...
			<ul class="metismenu" id="menu">
				...
				<li>
					...
					<ul>
						@can('import.item')
						<li class="{{ request()->is('import/database') ? 'mm-active' : '' }}">
											<a href="{{ route('import.database') }}"><i class='bx bx-radio-circle'></i>{{ __('item.manage_database') }}</a>
										</li>
						@endcan
						@can('import.item')
                ...
                <li>
                    ...
                    <ul>
						...
						@canany(['report.customer.due.payment', 'report.supplier.due.payment'])
							<li> <a class="has-arrow" href="javascript:;"><i class='bx bx-radio-circle'></i>{{ __('payment.due_reports') }}</a>
										<ul>
 ...
 --}}
                        ...
                        @canany(['report.transaction.cashflow', 'report.transaction.bank-statement'])
                        <li class="{{ request()->is('report/transaction/cashflow') ? 'mm-active' : '' }}">
                                            <a href="{{ route('report.transaction.cashflow') }}"><i class='bx bx-radio-circle'></i>{{ __('app.ladgerbook') }}</a>
                                        </li>
                        @endcan
						...
						@canany(['report.stock_report.*'])
							<li> <a class="has-arrow" href="javascript:;"><i class='bx bx-radio-circle'></i>{{ __('item.stock_report') }}</a>
										<ul>
                        ...
                        <!-- Implementation is pending, ItemTransaction should have state_id -->
                            ...
                            <li class="{{ request()->is('report/hsn_summary') ? 'mm-active' : '' }}">
                                                <a href="{{ route('report.hsn_summary') }}"><i class='bx bx-radio-circle'></i>{{ __('item.hsn_summary') }}</a>
                                            </li>
                            @endcan
                        @endif
