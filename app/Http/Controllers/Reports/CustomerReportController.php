            ...
            foreach ($preparedData as $data) {
                ...
                if($balanceData['balance'] != 0){
                    ...
                    $recordsArray[] = [  
                                    ...
                                    'party_id'            => $data->id,
                                    'party_phone' => $data->mobile ? $data->mobile : "N/A",
                                    'party_email' => $data->email ? $data->email : "N/A",
                                    'party_whatsapp' => $data->whatsapp ? $data->whatsapp : "N/A",
                                    'party_note' => $data->note ? $data->note : "N/A",
