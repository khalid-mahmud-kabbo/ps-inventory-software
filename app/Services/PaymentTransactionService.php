...
class PaymentTransactionService{
	 ...
	 *
	 * */
	public function recordPayment(Expense|PurchaseOrder|Purchase|PurchaseReturn|SaleOrder|Sale|SaleReturn|CashAdjustment|BankAdjustment|PartyPayment|Quotation $modelName, array $data)
    {
