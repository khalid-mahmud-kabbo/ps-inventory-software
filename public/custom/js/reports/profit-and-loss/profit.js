$(function() {
    ...
    function showSummaryOfReport(response) {
        ...
        const grossProfitSale = toNumber(_values.sale_gross_profit);
        const expenseResult  = toNumber(_values.indirect_expense_without_tax);
        const NetProfitResult = grossProfitSale - expenseResult;
        $("#sale_net_profit").text(_formatNumber(NetProfitResult));
    }
